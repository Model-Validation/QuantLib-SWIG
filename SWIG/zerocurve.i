...
%shared_ptr(InterpolatedZeroCurve<MixedRateTimeLinearParabolic>);
...
%template(MixedRateTimeLinearParabolicZeroCurve) InterpolatedZeroCurve<MixedRateTimeLinearParabolic>;
